...
public class TC_E2E_04 extends BaseClass{
	...
	public void testScripts() throws Exception{
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.view.MenuItem[@text='My Profile']").isDisplayed(), true , "Account Setting menu is not displayed ");
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.TextView[@text='My Addresses']").isDisplayed(), true , "My Profile screen is not displayed");
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.Button[@text='ADD ADDRESS']").isDisplayed(), true , "My Address screen is Not displayed");
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.TextView[@text='My Address']").isDisplayed(), true,"The new Address has not displayed in My address page");
