...
public class TC_E2E_01 extends BaseClass{
	...
	public void testCase() {
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.TextView[@text='MEN']").isDisplayed(), true , "Home Screen is not displayed");
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.TextView[@text='BOTTOMWEAR']").isDisplayed(), true , "Mens Category Screen is not displayed");
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.Button[@text='ADDED']").isDisplayed(), true , "Add to cart button is not changed to added");
		...
		softAssert.assertEquals(driver.findElementByXPath("//android.widget.Button[@text='Continue Shopping']").isDisplayed(),true , "Not navigated to cart screen ");
